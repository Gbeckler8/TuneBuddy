...
class Toolbar(QToolBar):
    ...
    def __init__(self):
        ...
        self.buttons["Clip"] = QAction("Clip", self)
        self.buttons["Clip"].setStatusTip("Clip active MIDI to certain range")
        self.buttons["Clip"].triggered.connect(self.trigger_clip)
